...
namespace CastleHero.GamePlay.InGame
{
    ...
    /// InGameBehaviour.Run 에서 생성되고 OnExit/Dispose 에서 파괴된다.
    ...
    public interface IInGameSession : IDisposable
    {
        ...
        ReactiveProperty<IUnitBehaviour> Castle { get; }
        ReactiveCollection<IUnitBehaviour> Characters { get; }
    ...
    {
        /// <summary>
        /// 전투 진행 중에만 non-null. InGameBehaviour.Run 에서 설정, Dispose 에서 해제.
        /// </summary>
        ...
        public ReactiveProperty<IUnitBehaviour> Castle => _draft.Castle;
        public ReactiveCollection<IUnitBehaviour> Characters => _draft.Characters;
